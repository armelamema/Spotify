...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['updateID'])) {
    ...
    $sql = "UPDATE spotify_most_streamed_songs SET track_name=?, artist_name=?, streams=? WHERE id=?";
        ...
        <?php if ($song): ?>
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="artistName" name="artistName" value="<?php echo htmlspecialchars($song['artist_name']); ?>" required>
                </div>
                <div class="mb-3">
